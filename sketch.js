...
function detectCollision(a, b){
    ...
    if (mbp.x-sbp.x <= b.body.width/2 +a.body.width/2 && sbp.x-mbp.x <= b.body.width/2 +a.body.width/2 && 
        mbp.y-sbp.y <= b.body.height/2 +a.body.height/2 && sbp.y-mbp.y <= b.body.height/2 +a.body.height/2){
